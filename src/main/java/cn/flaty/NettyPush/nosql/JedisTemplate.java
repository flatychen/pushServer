...
/**
 * 
 * 对springside JedisTemplate 进一步完善
 * 
 * @author flatychen
 * 
 */
public class JedisTemplate {
	...
	public void hset(final String key, final String fieldName,
			final String value) {
		execute(new JedisActionNoResult() {
	...
	public Boolean hsetnx(final String key, final String fieldName,
			final String value) {
		return execute(new JedisAction<Boolean>() {
	...
	public Long hincrBy(final String key, final String fieldName,
	...
	public Double hincrByFloat(final String key, final String fieldName,
	...
	public Long zremByScore(final String key, final double start,
			final double end) {
		return execute(new JedisAction<Long>() {
